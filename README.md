...
### Why does the code say it's version 1.2.0? 
---
It is 1.2.0 under the name RocketShip, but it's actually the 8th version of this framework (only the name as changed).
